...
const highlights: HighlightType[] = [
  {
    ...
    title: "No-code",
    description:
     " Lorem ipsum dolor sit, amet consectetur adipisicing elit. Ratione, placeat veritatis. Nisi rerum cum veritatis atque laboriosam, expedita dolorem dolor!",
  },
  {
    icon: "🎉",
